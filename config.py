...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument("--model", default="convnext_tiny", type=str, metavar="MODEL", help="Name of model to train")
    parser.add_argument("--drop_path", type=float, default=0, metavar="PCT", help="Drop path rate (default: 0.0)")
    ...
    parser.add_argument(
        "--warmup_epochs", type=int, default=10, metavar="N", help="epochs to warmup LR, if scheduler supports"
    )
    parser.add_argument(
        "--warmup_steps",
        type=int,
    ...
    parser.add_argument(
        "--resplit", type=str2bool, default=False, help="Do not random erase first (clean) augmentation split"
    )
    ...
    parser.add_argument(
        "--use_amp", type=str2bool, default=False, help="Use PyTorch's AMP (Automatic Mixed Precision) or not"
    )

    # Weights and Biases arguments
    parser.add_argument("--enable_wandb", type=str2bool, default=False, help="enable logging to Weights and Biases")
    parser.add_argument(
        "--project", default="convnext", type=str, help="The name of the W&B project where you're sending the new run."
    )
